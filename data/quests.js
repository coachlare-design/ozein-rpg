...
GameData.register('quests', {
  ...
  missao2: {
    ...
    rank: 'B',
    origem: 'Abre no BECO atrás da taverna, depois de concluir a Missão 1 (o recado de "Y.").',
  ...
  missao3: {
    ...
    rank: 'B',
    origem: 'Abre no Quadro de Contratos (taverna), depois de concluir a Missão 2 — contrato direto de Jack.',
